...
Tuono provides two choices for navigation between pages:

- The `Link` component - to be used in place of an `a` tag
- The `useRouter` hook - to be used programmatically change routes, or to access data about the current route
...
> For more information about this component visit the [dedicated API reference page](/documentation/components/link).
